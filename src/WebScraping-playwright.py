...
# --------------------------- Code ----------------------------
#<h1 class="dark-gray mv1 lh-copy f3 mh0 b" id="main-title" data-seo-id="hero-carousel-image" itemprop="name" data-fs-element="name" elementtiming="ip-main-title">iPad 8th Apple 10.2 Pulgadas 32GB Plata Reacondicionado</h1>
...
new_records = {
    ...
    "prices" : [info_walmart[1], info_amazon[1]]
}
